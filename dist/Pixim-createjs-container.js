/*!
 * @tawaship/pixim-createjs-container.js - v1.0.0
 * 
...
this.Pixim = this.Pixim || {}, function(exports, _Pixim) {
    ...
    }(makeClass(createjsOrigin.ButtonHelper, !0)), function(Pixim) {
        !function(createjs) {
            createjs.prepareAsync = function(id, basepath) {
                return function(id, basepath) {
            ...
            var Container = function(superclass) {
                ...
                Container.prototype.constructor = Container, Container.prototype.addCreatejs = function(cjs) {
                    if (cjs instanceof window.createjs.MovieClip) {
                        var createjsAnimID = this._createjsAnimID++;
                        cjs._childInstanceID = createjsAnimID, this.task.on("createjsAnim_" + createjsAnimID, (function(e) {
                            cjs._tick(e);
                        }));
                    }
                    return this.addChild(cjs.getPixi()), cjs;
                    ...
                    return this.addChildAt(cjs.getPixi(), index), cjs;
                    ...
                    return this.removeChild(cjs.getPixi()), cjs;
                }, Container.prototype.removeChildren = function() {
                    for (var i = this._lastCreatejsAnimID; i < this._createjsAnimID; i++) {
                        this.task.clear("createjsAnim_" + i);
                    }
                    return this._lastCreatejsAnimID = this._createjsAnimID, superclass.prototype.removeChildren.call(this);
                }, Container;
            }(_Pixim.Container);
            createjs.Container = Container;
        }(Pixim.createjs || (Pixim.createjs = {}));
    }(Pixim || (Pixim = {}));
    var prepareAsync = Pixim.createjs.prepareAsync, Container = Pixim.createjs.Container;
    exports.Container = Container, exports.prepareAsync = prepareAsync;
}(this.Pixim.createjs = this.Pixim.createjs || {}, Pixim);
//# sourceMappingURL=Pixim-createjs-container.js.map
